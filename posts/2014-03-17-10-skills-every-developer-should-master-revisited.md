...
categories: Coding
avatar: images/Yoda_Luke.jpg
hero: images/Yoda_Luke.jpg
...
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/wrench.jpg' />
</div>
...
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/oi-can.jpg' />
</div>
...
## Basic GNU Tools
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/toolbox.jpeg' />
</div>
...
## Bash
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/jack.jpg' />
</div>
...
## Javascript
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/Emergency-tool-kit.jpg' />
</div>
...
## Emacs
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/air-compressor.jpg' />
</div>
...
## SQL
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/obd-tool.jpg' />
</div>
...
## Markdown
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/pry-bar.jpg' />
</div>
...
##  R
<div class='hidden-xs hidden-sm col-md-4 image inline' style='float:right; margin:auto auto'>
  <img class='img-responsive'  src='images/tape-measure.jpg' />
</div>
